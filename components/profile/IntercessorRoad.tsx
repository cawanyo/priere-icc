      ...
      <div className="relative">
        ...
        return (
          ...
          <div key={step.id} className="flex flex-col items-center relative z-10 group">
                ...
                <motion.span
                  ...
                  className={`hidden md:flex absolute top-14 text-xs sm:text-sm font-medium whitespace-nowrap group-hover:flex ${isCurrent ? 'text-indigo-900 font-bold' : 'text-gray-500'}`}
        ...
        <div className="mt-16 bg-gray-50 p-4 rounded-lg border border-gray-100 text-center text-sm text-gray-600">
            ...
            <span className="text-red-600 font-medium">
              Votre demande a été refusée. Vous pouvez l'annuler pour en soumettre une nouvelle ultérieurement.
            </span>
